...
class _ActivityPageState extends State<ActivityPage> {
  ...
  void addNewActivity(String name, String time, String  image) {
    setState(() {
      categories[selectedCategoryIndex].activities.add(Activity(name: name, time: time, image: image),);
    });
  }
...
class _AddActivityDialogState extends State<AddActivityDialog> {
  ...
  style: OutlinedButton.styleFrom(
    foregroundColor: const Color.fromARGB(255, 99, 43, 254), side: const BorderSide(color: Color.fromARGB(255, 99, 43, 254)), // Border color
    shape: RoundedRectangleBorder(
