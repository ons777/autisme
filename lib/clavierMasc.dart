...
class _CommunicationAidState extends State<CommunicationAid> {
  ...
  List<String> Sentiments = ['Heureux', 'Triste', 'En colère', 'Excité', 'Fatigué', 'Confus', 'Surpris', 'Inquiet', 'Nerveux', 'Content', 'Calme', 'Solitaire', 'Aimé', 'Fier', 'Ennuyé', 'Timide', 'Amusé', 'Déçu'];
